...
export default function apiReducer(state = initialState, action) {
  switch (action.type) {
    case types.NEWPLUGIN202_GET__READ:
    case types.NEWPLUGIN202_GET__READ_SUCCEEDED:
    case types.NEWPLUGIN202_GET__READ_FAILED:
    ...
    case types.API_V1_GJHUYUIT_LIST:
    case types.API_V1_GJHUYUIT_LIST_SUCCEEDED:
    case types.API_V1_GJHUYUIT_LIST_FAILED:
    case types.API_V1_GJHUYUIT_CREATE:
    case types.API_V1_GJHUYUIT_CREATE_SUCCEEDED:
    case types.API_V1_GJHUYUIT_CREATE_FAILED:
    case types.API_V1_GJHUYUIT_READ:
    case types.API_V1_GJHUYUIT_READ_SUCCEEDED:
    case types.API_V1_GJHUYUIT_READ_FAILED:
    case types.API_V1_GJHUYUIT_UPDATE:
    case types.API_V1_GJHUYUIT_UPDATE_SUCCEEDED:
    case types.API_V1_GJHUYUIT_UPDATE_FAILED:
    case types.API_V1_GJHUYUIT_PARTIAL_UPDATE:
    case types.API_V1_GJHUYUIT_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_GJHUYUIT_PARTIAL_UPDATE_FAILED:
    case types.API_V1_GJHUYUIT_DELETE:
    case types.API_V1_GJHUYUIT_DELETE_SUCCEEDED:
    case types.API_V1_GJHUYUIT_DELETE_FAILED:
    case types.API_V1_HGFDJFD_LIST:
    case types.API_V1_HGFDJFD_LIST_SUCCEEDED:
    case types.API_V1_HGFDJFD_LIST_FAILED:
    case types.API_V1_HGFDJFD_CREATE:
    case types.API_V1_HGFDJFD_CREATE_SUCCEEDED:
    case types.API_V1_HGFDJFD_CREATE_FAILED:
    case types.API_V1_HGFDJFD_READ:
    case types.API_V1_HGFDJFD_READ_SUCCEEDED:
    case types.API_V1_HGFDJFD_READ_FAILED:
    case types.API_V1_HGFDJFD_UPDATE:
    case types.API_V1_HGFDJFD_UPDATE_SUCCEEDED:
    case types.API_V1_HGFDJFD_UPDATE_FAILED:
    case types.API_V1_HGFDJFD_PARTIAL_UPDATE:
    case types.API_V1_HGFDJFD_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_HGFDJFD_PARTIAL_UPDATE_FAILED:
    case types.API_V1_HGFDJFD_DELETE:
    case types.API_V1_HGFDJFD_DELETE_SUCCEEDED:
    case types.API_V1_HGFDJFD_DELETE_FAILED:
